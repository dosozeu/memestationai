...
def send_welcome(message):
    ...
    tip = types.KeyboardButton('Chart')
...
def echo_all(message):
    if message.text == 'Chart':
        bot.send_message(message.chat.id, 'https://www.dextools.io/app/en/ether/pair-explorer/0x1e138c0b050b91cd0b9f714bb30d9e698ee02c7a')
